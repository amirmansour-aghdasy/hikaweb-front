    ...
    return (
        <>
            ...
            <main className="w-full py-5 md:py-14 flex flex-col gap-10 md:gap-14" id={`${slug}-service-main-content`}>
                <Image src={mainBanner} width="0" height="0" sizes="100vw" className="w-full h-32 md:h-auto" alt={title} title={title} data-aos="zoom-in" />
                ...
                <section className="w-full grid grid-cols-12 gap-7 place-items-center">
                    <div className="w-full col-span-12 md:col-span-7 order-2 md:order-none">
                ...
                {finalDesc && (
                    <section className="w-full rounded-3xl bg-teal-500" id="installment-terms">
                        <div className="w-full h-full p-3.5 md:py-7 md:px-14 grid grid-cols-12 gap-y-10 md:gap-y-0 gap-x-0 md:gap-x-10 place-items-center justify-between">
                            <div className="w-full col-span-12 md:col-span-7 flex flex-col justify-center items-start gap-3.5 rounded-3xl bg-white p-3.5 md:px-12 md:py-7">
                                <h2 className="w-full text-xl md:text-3xl font-bold text-slate-700">{finalDesc.content.title}</h2>
                                <p className="w-full text-sm md:text-lg text-slate-700 leading-7 md:leading-8">{finalDesc.content.text}</p>
                            </div>
                            <div className="w-full col-span-12 grid place-items-center md:col-span-5">
