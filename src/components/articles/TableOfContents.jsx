    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-md p-6 border border-slate-200 dark:border-slate-700">
            <button
                ...
                className="w-full flex items-center justify-between mb-4 text-lg font-bold text-slate-800 dark:text-slate-100"
            >
                <div className="flex items-center gap-2">
                    <MdOutlineMenuBook className="w-5 h-5 text-teal-600 dark:text-teal-400" />
                ...
                <nav className="space-y-2">
                    {headings.map((heading, index) => (
                        <button
                            ...
                            className={`w-full text-right pr-4 py-2 rounded-lg transition-all duration-200 ${
